...
<link type="text/css" rel="stylesheet" href="css/style.css" />
    ...
    <center>
        <form name="onchange" id="first" action="winner" method="POST">
		<div class="container">
			<!-- Top Navigation -->
                        <br><br><br>
			<header>
...
<!--    <nav class="codrops-demos">
        ...
        Connection  con=DriverManager.getConnection("jdbc:mysql://localhost:3306/events","root","password");
                    ...
                    ResultSet rs1=st.executeQuery("SELECT * FROM windecl where sele='Approved");
                    while(rs1.next())
                ...
                <br><br><br>
                                        ...
                                        <br><br><a href="index.jsp" class="main-btn">BACK</a>
    </body>
</html>
