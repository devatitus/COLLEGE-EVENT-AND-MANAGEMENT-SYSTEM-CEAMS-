...
public final class evntlist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        {\n");
      out.write("        case \"Symposium\" :\n");
      out.write("            document.getElementById(\"status\").options[0]=new Option(\"Select status\",\"\");\n");
      out.write("            document.getElementById(\"status\").options[1]=new Option(\"Mock Interview\",\"Mock Interview\");\n");
      out.write("            document.getElementById(\"status\").options[2]=new Option(\"PPT\",\"PPT\");\n");
      out.write("            document.getElementById(\"status\").options[3]=new Option(\"Just a minute\",\"Just a minute\");\n");
      out.write("            document.getElementById(\"status\").options[4]=new Option(\"Web Desugning\",\"Web Desugning\");\n");
      out.write("            break;\n");
      out.write("            \n");
      out.write("        case \"Conference\" :\n");
      out.write("            document.getElementById(\"status\").options[0]=new Option(\"Select status\",\"\");\n");
      out.write("            document.getElementById(\"status\").options[1]=new Option(\"IEEE Collogium on 3D image\",\"IEEE Collogium on 3D image\");\n");
      out.write("            document.getElementById(\"status\").options[2]=new Option(\"5G for ubiquitous computing\",\"5G for ubiquitous computing\");\n");
      ...
      out.write("            \n");
      out.write("            break;\n");
      out.write("            case \"Workshop\" :\n");
      out.write("            document.getElementById(\"status\").options[0]=new Option(\"Select status\",\"\");\n");
      out.write("            document.getElementById(\"status\").options[1]=new Option(\"IOT\",\"IOT\");\n");
      out.write("            document.getElementById(\"status\").options[2]=new Option(\"BigData\",\"BigData\");\n");
      ...
      out.write("                    <form method=\"POST\" action=\"windecl.jsp\">\n");
      ...
      out.write("        <option value=\"Symposium\">Symposium</option>\n");
      ...
      out.write("                    </div>\n");
      out.write("</div> <div class=\"input-group\">\n");
      out.write("                        <div class=\"rs-select2 js-select-simple select--no-search\">   \n");
      out.write("                             <select id=\"status\" name=\"event\">\n");
      out.write("                            <script type=\"text/javascript\" language=\"JavaScript\">\n");
      out.write("        document.write('<select name=\"status\" id=\"status\"><option value=\"\"></option></select>')\n");
      out.write("        </script>\n");
      out.write("                   <noscript>\n");
      out.write("                   <option disabled=\"disabled\" selected=\"selected\"> </option>\n");
      out.write("        \n");
